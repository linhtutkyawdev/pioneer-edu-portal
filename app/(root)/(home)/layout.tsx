  ...
  return (
    <main className="relative">
      ...
      <SignedIn>
        <a
          href="/app"
          className="fixed bottom-0 right-0 my-6 mx-8 md:mx-16 z-50 px-6 py-4 flex items-center justify-center gap-2 bg-blue-1 shadow-lg rounded-full text-white cursor-pointer"
        >
          <span>App</span>
          <svg
            viewBox="0 0 16 16"
      ...
      {isAdmin && (
        <a
          href="/admin"
          className="fixed bottom-0 left-0 m-6 md:mx-16 z-50 px-6 py-4 flex items-center justify-center gap-2 bg-blue-1 shadow-lg rounded-full text-white cursor-pointer"
        >
          <span>Admin</span>
